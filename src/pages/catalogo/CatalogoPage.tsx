...
const Catalogo: React.FC = () => {
    ...
    return (
        <div className="flex w-screen min-h-screen justify-center items-center flex-col p-0 m-0">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" className="w-100 animate-fade animate-duration-1000 animate-delay-500" viewBox="0 0 4936.000000 808.000000" preserveAspectRatio="xMidYMid meet">
                <g transform="translate(0.000000,808.000000) scale(0.100000,-0.100000)" fill="#7e2a0c" stroke="none">
            ...
            <div
                ...
                onClick={() => {
                    criarProduto ? setAbrirFormProduto(true) : setAbrirFormCategoria(true)
                }}
            >
                <BotaoCriar tipo={criarProduto} />
            </div>
            ...
            {abrirFormProduto && (
                <div className="fixed inset-0 flex w-full h-full items-center justify-center bg-black/20 bg-opacity-50 p-4">
                    <div ref={formRef} className="bg-white rounded-lg shadow-lg mb-15 border-2 border-orange-900 relative">
                        <button
                        ...
                        <ProdutoForm
                            ...
                            idCard={produtoParaEditar ? produtoParaEditar.toString() : undefined}
                        />
                    </div>
                </div>
            )}
            ...
            {abrirFormCategoria && (
                <div className="fixed inset-0 flex items-center justify-center scale-75">
                    <div ref={formRef} className="bg-white p-6 rounded-lg shadow-lg w-1/2 relative border-2 border-orange-900">
                        <button
                        ...
                        <CategoriaForm
                            ...
                            idCard={categoriaParaEditar ? categoriaParaEditar.toString() : undefined}
                        />
                    </div>
                </div>
            )}
