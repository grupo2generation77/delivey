        ...
        <div>
            <div style={container}>
                ...
                >
                    ...
                    <Navigation />
                    <MenuToggle toggle={() => setIsOpen(!isOpen)} isSmallScreen={isSmallScreen} />
                </motion.nav>
            </div>
        </div>
    );
...
const MenuToggle = ({ toggle, isSmallScreen }: { toggle: () => void; isSmallScreen: boolean }) => (
    <button style={{ ...toggleContainer, width: isSmallScreen ? 50 : 120 }} onClick={toggle}>
        {isSmallScreen ? (
