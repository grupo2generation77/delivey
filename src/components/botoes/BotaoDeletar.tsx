...
export function BotaoDeletar(i:number){
  return (
    <button className={"group relative flex h-12 w-10 flex-col items-center justify-center overflow-hidden bg-red-900 hover:bg-red-600 rounded-br-xl "+(i%2!=0? " rounded-tr-4xl" : "")}>
