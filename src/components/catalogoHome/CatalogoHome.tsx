export const CatalogoHome: React.FC = () => {
    return (
        ...
        {/* Catálogo */}
            <div id="catalogo" className="flex justify-center items-start wire-one-regular text-orange-900 p-5 font-bold gap-2 select-none max-w-[90%] flex-wrap ">
            ...
            {[...Array(4)].map((item) => (
                <div
                key={item}
                className={`bg-white drop-shadow-lg h-fill md:w-70  lg:w-full ${item%2==0? 'rounded-tl-4xl rounded-bl-4xl' : 'rounded-tr-4xl rounded-br-4xl'} flex flex-col items-center hover:scale-105 transition-transform animate-fade-up animate-duration-1000 animate-delay-500`}
                >
                <img
